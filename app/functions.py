    ...
    azure_endpoint=os.getenv("AZURE_OPENAI_ENDPOINT")
        ...
        try:
            ...
            assistant = client.beta.assistants.create(
                model="munyaradzi",
                name="umuDhumeni",
                instructions="""You are an AI assistant designed to help farmers with their queries. 
                                When users ask questions, provide comprehensive responses and encourage follow-up questions.
                                If a user sends an image URL, call the 'process_image_with_openai' tool to analyze the image.
                                Incorporate the image description into your response, followed by prompts for further queries.
                                Always identify the user's phone number in each request as it is crucial for our operations.""",
                tools=[
                    {
                        "type": "function",
                        "function": {
